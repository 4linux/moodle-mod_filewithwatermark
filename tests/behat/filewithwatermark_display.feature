...
Feature: Teacher can specify different display options for the resource
  ...
  Scenario: Specifying no additional display options for a file resource
    ...
    And I upload "mod/filewithwatermark/tests/generator/filewithwatermark_test_file.pdf" file to "Select files" filemanager
  ...
  Scenario Outline: Specifying different display options for a file resource
    ...
    And I upload "mod/filewithwatermark/tests/generator/filewithwatermark_test_file.pdf" file to "Select files" filemanager
    And I press "Save and display"
    Then I <seesize> see "8.2KB" in the ".resourcedetails" "css_element"
    And I <seetype> see "PDF document" in the ".resourcedetails" "css_element"
    And I <seedate> see "Uploaded" in the ".resourcedetails" "css_element"
    And I am on "Course 1" course homepage
    And I <seesize> see "8.2KB" in the ".activity.filewithwatermark .resourcelinkdetails" "css_element"
    And I <seetype> see "PDF document" in the ".activity.filewithwatermark .resourcelinkdetails" "css_element"
    And I <seedate> see "Uploaded" in the ".activity.filewithwatermark .resourcelinkdetails" "css_element"
    And I log out
