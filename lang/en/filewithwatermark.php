...
$string['cannotgeneratewatermark'] = 'Could not generate watermark';
...
$string['modulename'] = 'File with watermark';
$string['modulename_help'] = 'The file with watermark module enables a teacher to provide a watermarked file as a course resource. Students will be able to download it. The file may be a PDF file.';
$string['modulenameplural'] = 'Files with watermark';
$string['name'] = "Name";
$string['notmigrated'] = 'This legacy resource type ({$a}) was not yet migrated, sorry.';
$string['pluginadministration'] = 'File with watermark module administration';
$string['pluginname'] = "File with watermark";
...
$string['requiredfiles'] = 'File is required';
